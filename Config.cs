...
namespace TKInfo
{
    public class Config : IConfig
    {
        ...
        public string webhookHurtText { get; set; } = ":brown_square: [HURT] :brown_sqare: {Time} {target} ({targetID}) playing as {targetRole} was hurt by their teammate {attacker} ({attackerID}) playing as {attackerRole} with {damageType} <@&{roleID}>";
