...
namespace TKInfo
{
    public class EventsHandler
    {
        ...
        {
            if ((ev.Killer == null || ev.Killer == ev.Target) && Plugin.instance.Config.logSuicides && !Plugin.instance.Config.deathsNotToCoundAsSuicide.Contains(ev.Handler.Type.ToString()))
            {
